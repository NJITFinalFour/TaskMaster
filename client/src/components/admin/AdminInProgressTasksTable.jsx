...
const AdminInProgressTasksTable = () => {
  ...
  return (
    <Container>
      ...
      <TaskWrapper>{displayTable(inProgressTasks)}</TaskWrapper>
    </Container>
  );
};

export default AdminInProgressTasksTable;
