...
export const loginUser = async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({ email, token, userFirstName: user.first_name, userLastName: user.last_name, isAdmin: user.isAdmin, oranization: user.organization, _id: user._id });
  } catch (error) {
